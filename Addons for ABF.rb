...
module ABFAddons
  ...
  CHECKED_FOR_UPDATES = false # Добавляем флаг
  ...
  def self.check_for_updates
    # Проверяем, не было ли уже проверки в этом сеансе
    ...
    # Устанавливаем флаг, что проверка была выполнена
  ...
  unless file_loaded?(__FILE__)
    ...
    # --- Запускаем таймер для проверки обновлений ---
